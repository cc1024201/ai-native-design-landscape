...
- **Evidence-bounded deep dossiers complete:** 31 / 63 — 18 Source-level dossiers plus Claude Design, Replit Design, QoderWork Design, TRAE Work Design, Cursor, Tencent CodeBuddy, Baidu Comate, Devin, historical Windsurf, Diagram, Galileo AI, Motiff and Stitch at Architecture-level with the closed-source evidence boundary reached.
...
- **Remaining dossiers:** 32 / 63 at Seed, Product-level, or unfinished Architecture-level depth.
...
The dossiers now also establish twenty different durable-refinement models. “Structured” does not by itself mean that every product has one equivalent source of truth:
...
The dossiers now separate twenty artifact-production profiles that can all look like “the agent made a design” at the UI level:
