...
- **Evidence-bounded deep dossiers complete:** 22 / 63 — 18 Source-level dossiers plus Claude Design, Replit Design, QoderWork Design and TRAE Work Design at Architecture-level with the closed-source evidence boundary reached.
...
- **Remaining dossiers:** 41 / 63 at Seed, Product-level, or unfinished Architecture-level depth.
...
The dossiers now also establish twelve different durable-refinement models. “Structured” does not by itself mean that every product has one equivalent source of truth:
...
The dossiers now separate eleven artifact-production profiles that can all look like “the agent made a design” at the UI level:
...
**v0.1 depth:** in progress — 22 evidence-bounded deep dossiers complete (18 Source-level and 4 closed-source Architecture-level), 41 remaining.
