...
- **Evidence-bounded deep dossiers complete:** 20 / 63 — 18 Source-level dossiers plus Claude Design and Replit Design at Architecture-level with the closed-source evidence boundary reached.
...
- **Remaining dossiers:** 43 / 63 at Seed, Product-level, or unfinished Architecture-level depth.
...
The dossiers now also establish ten different durable-refinement models. “Structured” does not by itself mean that every product has one equivalent source of truth:
...
The dossiers now separate nine artifact-production profiles that can all look like “the agent made a design” at the UI level:
...
**v0.1 depth:** in progress — 20 evidence-bounded deep dossiers complete (18 Source-level and 2 closed-source Architecture-level), 43 remaining.
