...
- **Evidence-bounded deep dossiers complete:** 29 / 63 — 18 Source-level dossiers plus Claude Design, Replit Design, QoderWork Design, TRAE Work Design, Cursor, Tencent CodeBuddy, Baidu Comate, Devin, historical Windsurf, Diagram and Galileo AI at Architecture-level with the closed-source evidence boundary reached.
...
- **Remaining dossiers:** 34 / 63 at Seed, Product-level, or unfinished Architecture-level depth.
...
The dossiers now also establish eighteen different durable-refinement models. “Structured” does not by itself mean that every product has one equivalent source of truth:
...
The dossiers now separate eighteen artifact-production profiles that can all look like “the agent made a design” at the UI level:
...
**v0.1 depth:** in progress — 29 evidence-bounded deep dossiers complete (18 Source-level and 11 closed-source Architecture-level), 34 remaining.
