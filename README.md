...
- **Evidence-bounded deep dossiers complete:** 33 / 63 — 18 Source-level dossiers plus Claude Design, Replit Design, QoderWork Design, TRAE Work Design, Cursor, Tencent CodeBuddy, Baidu Comate, Devin, historical Windsurf, Diagram, Galileo AI, Motiff, Stitch, Google Antigravity and Figma Make at Architecture-level with the closed-source evidence boundary reached.
...
- **Remaining dossiers:** 30 / 63 at Seed, Product-level, or unfinished Architecture-level depth.
...
The dossiers now also establish twenty-two different durable-refinement models. “Structured” does not by itself mean that every product has one equivalent source of truth:
...
The dossiers now separate twenty-three artifact-production profiles that can all look like “the agent made a design” at the UI level:
...
**v0.1 depth:** in progress — 33 evidence-bounded deep dossiers complete (18 Source-level and 15 closed-source Architecture-level), 30 remaining.
